...
class CompliancePannedCdtToExcelReport(models.AbstractModel):
    _name = "report.process_control.compliance_planned_cdt"
    _description = "Compliance Planned CDT Report"
