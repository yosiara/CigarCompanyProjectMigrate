...
class SetOfPeacesNomenclature(models.Model):
    ...
    _rec_name = "name"
    _description = "Nombres de subconjuntos de piezas"

    name = fields.Char('Nombre', size=40, required=True)
    quantity = fields.Integer(string="Cantidad", required=True, default=1)
    machine_type_ids = fields.Many2many('process_control.machine_type', string='Machine Type', relation="machine_set_of_peaces_machine_type",
