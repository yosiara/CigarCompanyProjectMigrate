...
class Meeting(models.Model):
    ...
    short_name_aux = fields.Char(string='Nombre corto', size=30)
    task_type = fields.Selection([('Plan', 'Plan'), ('Extra Plan', 'Extra Plan')], string='Tipo', default='Plan')
    priority = fields.Selection([('1', 'Normal'), ('2', 'Alta')], string='Prioridad', default='1')
    user_id = fields.Many2one('res.users', 'Organizer', default=False)
