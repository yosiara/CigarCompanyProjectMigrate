...
class ControlApplications(models.TransientModel):
    _name = "computers_inventory.control_applications"
    ...
    def print_report(self):
        ...
        if self.format == 'pdf':
            return self.env['ir.actions.report'].get_action(self, 'l10n_cu_hlg_computers_inventory.report_control', data=data)
        else:
            return {
                'type': 'ir.actions.report.xml',
                'report_name': 'l10n_cu_hlg_computers_inventory.report_control_docx',
                'datas': data
            }
