...
class MaintenanceEquipment(models.Model):
    ...
    quantity_movements_for_approval = fields.Integer(string="Quantity Movements For Approval")
    ...
    def _compute_has_movements_for_approval(self):
        ...
        # print("Self: ******", self)
        # for rec in self:
        #     aux = self.env('maintenance.equipment').search([('equipment_id', '=', rec.id), ('state', '=', 'waiting_approval')])
        #     if aux:
        self.has_movements_for_approval = False
