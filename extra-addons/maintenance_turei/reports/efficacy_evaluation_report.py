...
class EfficacyEvaluationReport(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        worksheet.insert_image('B2:C3', addons_manifest['maintenance_turei']['addons_path'] + '/maintenance_turei/static/src/img/tabacuba.jpg',
        ...
        evaluation_parameter = self.env['maintenance_turei.evaluation_parameter'].search([])
        ...
        planif_count = self.env['maintenance_turei.work_order'].search_count(['|', ('work_type', '=', 'plan_ciclo'), ('work_type', '=', 'plan_et'), ('opening_date', '>=', lines.date_start), ('opening_date', '<=', lines.date_end)])
        imprev_count = self.env['maintenance_turei.work_order'].search_count([('work_type', '=', 'imp-tec'), ('opening_date', '>=', lines.date_start), ('opening_date', '<=', lines.date_end)])
...
EfficacyEvaluationReport('report.maintenance_turei.efficacy_evaluation_report', 'wzd.efficacy.evaluation')
