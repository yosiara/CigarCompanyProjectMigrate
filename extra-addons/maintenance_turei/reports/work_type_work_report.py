...
class WorkTypeWorkReport(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        for mt in work_type:
            work_order = self.env['maintenance_turei.work_order'].search([('opening_date', '>=', lines.date_start), ('opening_date', '<=', lines.date_end), ('work_type', '=', mt)])
...
WorkTypeWorkReport('report.maintenance_turei.work_type_work_report', 'wzd.work.type.work')
