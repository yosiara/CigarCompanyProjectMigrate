...
class ResourcesConsumedReport(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        work_order = self.env['maintenance_turei.work_order'].search(domain, order='opening_date')
...
ResourcesConsumedReport('report.maintenance_turei.resources_consumed_report', 'wzd.resources.consumed')
