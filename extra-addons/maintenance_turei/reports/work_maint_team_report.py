...
class WorkMaintTeamReport(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        for mt in maint_team:
            work_order = self.env['maintenance_turei.work_order'].search([('opening_date', '>=', lines.date_start), ('opening_date', '<=', lines.date_end), ('maintenance_team_id', '=', mt.id)])
...
WorkMaintTeamReport('report.maintenance_turei.work_maint_team_report', 'wzd.work.maint.team')
