...
class ImportWizard(TransientModel):
    _name = 'maintenance_turei.import_wizard'
    _description = 'maintenance_turei.import_wizard'
    ...
    def action_import_cycle_maintenance(self):
        ...
        cycle_maintenance_obj = self.env['maintenance_turei.cycle_maintenance']
    ...
    def import_line(self):
        ...
        equipment_obj = self.env['maintenance.equipment']
        linea_obj = self.env['maintenance_turei.line']
        x = 0
        while x < sheet.nrows:
            try:
                code = sheet.cell_value(x, 0)
    ...
    def import_electric_motor(self):
        ...
        electric_motor_obj = self.env['maintenance_turei.equipment_electric_motor']
    ...
    def _save_file(self):
        # path = get_module_path('maintenance_turei')
