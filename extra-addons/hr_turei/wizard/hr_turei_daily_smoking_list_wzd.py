...
class HrTureiDailySmokingWzd(models.TransientModel):
    _name = 'hr_turei.daily_smoking_wzd'
    ...
    def export_to_xls(self):
        return self.env['report'].get_action(self, 'hr_turei.daily_smoking_list', data={
