...
import { CommunityBurgerMenu } from "@web_community/webclient/burger_menu/burger_menu";
...
QUnit.module("Burger Menu Community", {
    beforeEach() {
...
QUnit.test("Burger Menu on home menu", async (assert) => {
    ...
    await createCommunityWebClient({ serverData });
