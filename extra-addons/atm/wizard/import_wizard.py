...
class ImportWizard(TransientModel):
    _name = 'atm.import_wizard'
    _description = 'atm.import_wizard'
    ...
    def action_import_responsibility_areas(self):
        ...
        return {
            ...
            'tag': 'reload',
            'params': {'menu_id': self.env.ref('atm.atm_responsibility_area_menu_item').id},
        }
    ...
    def action_import_cost_centers(self):
        ...
        return {
            'type': 'ir.actions.client',
            'tag': 'reload',
            'params': {'menu_id': self.env.ref('atm.atm_cost_enter_menu_item').id},
        }
