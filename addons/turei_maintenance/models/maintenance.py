...
class MaintenanceEquipment(models.Model):
    ...
    equipment_parts_ids = fields.One2many(compute="_compute_equipment_parts", comodel_name='turei_maintenance.equipment_parts')
    ...
    equipment_electric_motor_ids = fields.One2many(compute="_compute_equipment_electric_motor", comodel_name='turei_maintenance.equipment_electric_motor')
    cycle_maintenance_ids = fields.One2many(comodel_name='turei_maintenance.cycle_maintenance', inverse_name='equipment_id', string='Ciclos de mantenimiento')
    ...
    config_cycle = fields.Many2one('turei_maintenance.cycle_maintenance', string='Ciclo', domain="[('equipment_id', '=', id)]")
...
class CycleMaintenancePlan(models.Model):
    ...
    equipment_id = fields.Many2one(comodel_name="maintenance.equipment", string="Equipos",
                                   ondelete='cascade')
    cycle = fields.Many2one('turei_maintenance.cycle_maintenance', string='Ciclo', domain="[('equipment_id', '=', equipment_id)]")
