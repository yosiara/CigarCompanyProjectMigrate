...
class XlsReportCyears(models.TransientModel):
    _name = 'app_seleccion.xls_report_cyears'
    ...
    def print_report(self):
        ...
        return self.env['report'].get_action(self, 'app_seleccion.xls_report_cyears', data=datas)
