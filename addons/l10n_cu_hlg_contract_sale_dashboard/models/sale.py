...
class ContractSaleDashboard(models.Model):
    _name = 'contract.sale.dashboard'
    _description = 'Sale Contract Dashboard'
    ...
    def get_data_info(self):
        ...
        query_sum = """
                        ...
                        where cast(date_invoice as varchar) like %s and state in %s and type = 'out_invoice';
                    """
        ...
        contract_sql_due_date = """
                            select c.number, c.name as contract, p.name as partner, ct.name as type, c.date_end as date
                                ...
                                and c.flow = 'customer' and c.date_end >= %s and c.state = 'open'
        ...
        data = {
            ...
            'view_invoice_id': view_invoice_id,
        }
