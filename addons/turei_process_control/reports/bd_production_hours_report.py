...
class BdProductionHoursToExcelReport(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        production_hours = self.env['turei_process_control.tecnolog_control_model'].search([('date','>=',lines.date_start),('date','<=',lines.date_end)], order="date, productive_section")
        ...
        worksheet.write('D4', 'Seccion Productiva', merge_format)
        worksheet.write('E4', 'Turno', merge_format)
        worksheet.set_row(3,45)
        worksheet.set_column('C4:J4', 10)
        worksheet.write('F4', '1era Hora 7 a.m - 8 a.m', merge_format)
        worksheet.write('G4', '2da Hora 8 a.m - 9 a.m', merge_format)
        worksheet.write('H4', '3ra Hora 9 a.m - 10 a.m', merge_format)
        worksheet.write('I4', '4ta Hora 10 a.m - 11 a.m', merge_format)
        worksheet.write('J4', '5ta Hora 11 a.m - 12 p.m', merge_format)
        worksheet.write('K4', '6ta Hora 12 p.m - 1 p.m', merge_format)
        worksheet.write('L4', '7ma Hora 1 p.m - 2 p.m', merge_format)
        worksheet.write('M4', '8va Hora 2 p.m - 3 p.m', merge_format)
        ...
        worksheet1.write('D4', 'Seccion Productiva', merge_format)
        worksheet1.write('E4', 'Turno', merge_format)
        worksheet1.set_row(3,45)
        worksheet1.set_column('C4:J4', 10)
        worksheet1.write('F4', '1era Hora 3 p.m - 4 p.m', merge_format)
        worksheet1.write('G4', '2da Hora 4 p.m - 5 p.m', merge_format)
        worksheet1.write('H4', '3ra Hora 5 p.m - 6 p.m', merge_format)
        worksheet1.write('I4', '4ta Hora 6 p.m - 7 p.m', merge_format)
        worksheet1.write('J4', '5ta Hora 7 p.m - 8 p.m', merge_format)
        worksheet1.write('K4', '6ta Hora 8 p.m - 9 p.m', merge_format)
        worksheet1.write('L4', '7ma Hora 9 p.m - 10 p.m', merge_format)
        worksheet1.write('M4', '8va Hora 10 p.m - 11 p.m', merge_format)
...
BdProductionHoursToExcelReport('report.turei_process_control.bd_production_hours_report', 'wzd.bd.production.hours.to.excel')
