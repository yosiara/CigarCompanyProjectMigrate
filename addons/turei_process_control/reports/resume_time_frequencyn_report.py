...
class ResumenTimeFrequencynToExcelReport(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        if lines.turn:
            ...
            worksheet.insert_textbox('A2:K2', tools.ustr("REPORTE RESUMEN DE TIEMPO Y FRECUENCIA POR SECCIÓN PRODUCTIVA (DESDE %s HASTA %s) TURNO %d") % (lines.date_start, lines.date_end, lines.turn.sgp_turn_id.sgp_id),
