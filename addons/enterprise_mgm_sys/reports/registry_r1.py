...
class RegistryR1(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        worksheet.merge_range('E6:I6', tools.ustr('Área de Trabajo: %s' % lines.department_id.name if lines.department_id else ''), normal_format_no_border)
...
RegistryR1('report.enterprise_mgm_sys.registry_r1_report', 'enterprise_mgm_sys.registryr1')
