...
class UseOfTimeToExcelTobaccoReport(ReportXlsx):
    @api.model
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        for tc in tecnolog_control:
            ...
            worksheet.write(x, 5, round(tc.reconstituted_produced/tc.productive_capacity,2), normal_format)
            ...
            tnj = tc.plan_time-(round(tc.reconstituted_produced/tc.productive_capacity,2) + round(tti/60,2))
...
UseOfTimeToExcelTobaccoReport('report.process_control_tobacco.use_of_time_report', 'wzd.use.of.time.to.excel.tobacco')
