/**
 * Created by vladimir on 14/01/17.
 */
...
var Dashboard = Widget.extend({
    ...
    load: function(dashboards){
        ...
        // session.rpc("/theme_desoft_blue/data", {}).then(function (data) {
            /* Load each dashboard*/
...
var DashboardInvitations = Widget.extend({
    template: 'DashboardInvitations_turei',
    events: {
...
var DashboardPlanner = Widget.extend({
    ...
    template: 'DashboardPlanner_turei',
...
var DashboardShare = Widget.extend({
    ...
    init: function(parent, data){
        this.data = data;
        this.parent = parent;
        this.share_url = 'http://turei.com';/*'https://www.odoo.com';*/
        /*this.share_text = encodeURIComponent("I am using #Odoo - Awesome open source business apps.");*/
        this.share_text = encodeURIComponent("I am using a http://turei.com app.");
    },
    ...
    share_linkedin: function(){
        ...
        var popup_url = _.str.sprintf('http://www.linkedin.com/shareArticle?mini=true&url=%s&title=I am using a turei apps&summary=%s&source=www.turei.com', encodeURIComponent(this.share_url), this.share_text);
        this.sharer(popup_url);
    },
